...
import {CustomerViewHeaderPersonalXComponent} from 'app/impl/customer/customer-view/customer-view-header-personal/customer-view-header-personal-x.component';
