...
@Component({
  ...
  templateUrl: './asset-document-add-edit-x.component.html',
  styleUrls: []
})
export class AssetDocumentAddEditXComponent implements OnInit {
  ...
  result: AssetDocListXObj = new AssetDocListXObj();
  assetDocListObj: AssetDocListXObj = new AssetDocListXObj();
  tempAssetName: any;
  ...
  SaveForm() {
    if (this.pageType == "add") {
      this.assetDocListObj = new AssetDocListXObj();
      ...
      this.assetDocListObj.IsCustodian = this.AssetDocumentForm.controls["IsCustodian"].value;
      this.assetDocListObj.AssetTypeId = this.AssetTypeId;

      //new API X untuk submit ke table core & X
      //new API X untuk submit ke table core & X
      //new API X untuk submit ke table core & X
