...
export class CustBankAccDetailSectionFindataXComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if (this.pageType == "edit") {
      ...
      this.httpClient.post(URLConstantX.GetCustBankAccByCustBankAccIdWithRefBank, { Id: this.CustBankAccId }).subscribe(
        (response: any) => {
          ...
          this.CustBankAccForm.patchValue({
            ...
            MrPlafonFromBank: response.CustBankAccObjX.MrPlafonFromBank == null ? "" : response.CustBankAccObjX.MrPlafonFromBank
          });
          this.CheckDefault();
        }
      );
      ...
      this.httpClient.post(URLConstantX.GetCBAForCustFinDataEditModeByCustBankAccId, ReqCustBankAcc).subscribe(
        (response: any) => {
  ...
  Save(enjiForm) {
    ...
    this.custBankAccObjX.MrPlafonFromBank = formData.MrPlafonFromBank;
    if (this.pageType == "add") {
      this.httpClient.post(URLConstantX.AddCustBankAcc, this.custBankAccObjX).subscribe(
        (response) => {
      ...
      if (this.pageType == "edit") {
        ...
        this.httpClient.post(URLConstantX.EditCustBankAcc, custBankData).subscribe(
          (response) => {
            this.activeModal.close(response);
          }
        );
