...
export class CustomerCompanyContactInformationComponentX implements OnInit {
  ...
  async SaveValue(IsParent: boolean = false): Promise<boolean> {
    ...
    this.custAddrObj.Addr = (this.ContactInformationForm.value.UcAddress.Addr === null || this.ContactInformationForm.value.UcAddress.Addr === undefined) ? "" : this.ContactInformationForm.value.UcAddress.Addr;
    this.custAddrObj.AreaCode1 = (this.ContactInformationForm.value.UcAddress.AreaCode1 === null || this.ContactInformationForm.value.UcAddress.AreaCode1 === undefined) ? "" : this.ContactInformationForm.value.UcAddress.AreaCode1;
    this.custAddrObj.AreaCode2 = (this.ContactInformationForm.value.UcAddress.AreaCode2 === null || this.ContactInformationForm.value.UcAddress.AreaCode2 === undefined) ? "" : this.ContactInformationForm.value.UcAddress.AreaCode2;
    this.custAddrObj.AreaCode3 = (this.ContactInformationForm.value.UcAddress.AreaCode3 === null || this.ContactInformationForm.value.UcAddress.AreaCode3 === undefined) ? "" : this.ContactInformationForm.value.UcAddress.AreaCode3;
    this.custAddrObj.AreaCode4 = (this.ContactInformationForm.value.UcAddress.AreaCode4 === null || this.ContactInformationForm.value.UcAddress.AreaCode4 === undefined) ? "" : this.ContactInformationForm.value.UcAddress.AreaCode4;
    this.custAddrObj.City = (this.ContactInformationForm.value.UcAddress.City === null || this.ContactInformationForm.value.UcAddress.City === undefined) ? "" : this.ContactInformationForm.value.UcAddress.City;
    this.custAddrObj.Zipcode = (this.ContactInformationForm.value.UcAddressZipcode.value === null || this.ContactInformationForm.value.UcAddressZipcode.value === undefined) ? "" : this.ContactInformationForm.value.UcAddressZipcode.value;
