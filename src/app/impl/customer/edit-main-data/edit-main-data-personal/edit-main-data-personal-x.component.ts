...
export class EditMainDataPersonalXComponent implements OnInit {
  ...
  constructor(private router: Router, private route: ActivatedRoute, private http: HttpClient, private fb: FormBuilder, 
    ...
    this.getCustByCustIdUrl = URLConstantX.GetCustXByCustId;
    ...
    await this.http.post(URLConstant.GetCustByCustId, { Id: this.CustId }).toPromise().then(
      (response) => {
        ...
        this.CustomerPersonalForm.patchValue({          
          ...
          GelarDepan: this.tempCustObj.GelarDepan,
          GelarBelakang: this.tempCustObj.GelarBelakang,
        });
  ...
  SaveValue() {
    ...
    this.custObj.CustPrefixName = this.CustomerPersonalForm.controls["CustPrefixName"].value;
    this.custObj.CustSuffixName = this.CustomerPersonalForm.controls["CustSuffixName"].value;
    ...
    this.custPersonalObj.CustPersonalId = this.tempCustPersonalObj.CustPersonalId,
