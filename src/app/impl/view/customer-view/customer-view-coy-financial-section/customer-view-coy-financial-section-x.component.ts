...
@Component({
  selector: 'app-customer-view-coy-financial-section-x',
  templateUrl: './customer-view-coy-financial-section-x.component.html'
})
export class CustomerViewCoyFinancialSectionXComponent implements OnInit {
  CustId: number;
  TitleSuffix:string = '';
