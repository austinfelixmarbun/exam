...
@Component({
  selector: 'app-customer-view-coy-financial-x',
  templateUrl: './customer-view-coy-financial-x.component.html'
})
export class CustomerViewCoyFinancialXComponent implements OnInit {
  CustId: number;
  TitleSuffix:string = '';
