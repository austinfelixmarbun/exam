...
@Component({
  selector: 'app-customer-view-personal-financial-section-x',
  templateUrl: './customer-view-personal-financial-section-x.component.html'
})
export class CustomerViewPersonalFinancialSectionXComponent implements OnInit {
  tempCustObj: any;
  CustId: number;
  ...
  async ngOnInit() {
    ...
    await this.http.post(URLConstantX.GetListCustPersonalFinDataForCustViewByCustId, {custId : this.CustId }).toPromise().then(
      (response) => {
