...
@Component({
  selector: 'app-customer-view-personal-job-data-sme-x',
  templateUrl: './customer-view-personal-job-data-sme-x.component.html'
})
export class CustomerViewPersonalJobDataSmeXComponent implements OnInit {
  ...
  ngOnInit() {
    this.viewCustJobDataSme.viewInput =  "./assets/impl/ucviewgeneric/viewCustJobDataSme.json";
