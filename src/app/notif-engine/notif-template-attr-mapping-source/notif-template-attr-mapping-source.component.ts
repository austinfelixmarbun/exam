...
export class NotifTemplateAttrMappingSourceComponent implements OnInit {
  ...
  readonly CancelLink: string = NavigationConstant.NOTIF_ENGINE_NOTIF_ATTR_TEMPLATE_MAPPING_PAGING;
  ...
  ngOnInit() {
    ...
    critInput.propName = "RNAC.MR_NOTIFICATION_SOURCE_CODE";
    critInput.restriction = AdInsConstant.RestrictionEq;
    critInput.value = this.SourceCode;
