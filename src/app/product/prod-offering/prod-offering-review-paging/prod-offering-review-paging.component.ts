...
@Component({
  selector: 'app-prod-offering-review-paging',
  templateUrl: './prod-offering-review-paging.component.html'
})
export class ProdOfferingReviewPagingComponent implements OnInit {
