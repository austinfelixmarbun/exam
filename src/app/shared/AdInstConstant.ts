...
export class AdInsConstant {
  ...
  public static GetListProdOfferingDByProdOfferingHIdAndProdCompntGrpCode = "http://localhost:5000/ProductOffering/GetListProdOfferingDByProdOfferingHIdAndProdCompntGrpCode"
