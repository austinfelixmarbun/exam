...
export class NavigationConstant {
    ...
    public static VIEW_CUST_PERSONAL_EMERGENCY_CONTACT = "/" + NavigationConstant.VIEW_CUST + "/" + PathConstant.VIEW_CUST_PERSONAL_EMERGENCY_CONTACT; //'/View/Customer/PersonalEmergencyContact'
