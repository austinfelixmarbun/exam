...
async function saveCustCompanyDetailV2(dicts: Record<string, any>, api: any, http: HttpClient, toastr: NGXToastrService)
{
  ...
  custCompanyObj.CustCompanyId = dicts.CustCompanyId;
  custCompanyObj.CustId = dicts.IdCust;
  custCompanyObj.Email1 = dicts.Email1 == null ? "": dicts.Email1;
  custCompanyObj.Email2 = dicts.Email2 == null ? "": dicts.Email2;
  custCompanyObj.EstablishmentDt = dicts.form.EstablishmentDt;
  custCompanyObj.IsAffiliateWithMf = dicts.form.IsAffiliateWithMf;
  custCompanyObj.IsAffiliated = dicts.IsAffiliated;
  custCompanyObj.IsSkt = dicts.form.IsSkt;
  custCompanyObj.IsVip = dicts.form.IsVip;
  custCompanyObj.LicenseNo = dicts.LicenseNo == null ? "": dicts.LicenseNo;
  custCompanyObj.MrCompanyTypeCode = dicts.MrCompanyTypeCode;
  custCompanyObj.MrCustModelCode = dicts.form.MrCustModelCode;
  custCompanyObj.MrInvestmentTypeCode = dicts.MrInvestmentTypeCode == null ? "": dicts.MrInvestmentTypeCode;
  custCompanyObj.NumOfEmp = dicts.form.NumOfEmp;
  custCompanyObj.ParentCustId = dicts.form.ParentCustId;
  custCompanyObj.Phn1 = dicts.Phn1 == null ? "": dicts.Phn1;
  custCompanyObj.Phn2 = dicts.Phn2 == null ? "": dicts.Phn2;
  custCompanyObj.PhnArea1 = dicts.PhnArea1 == null ? "": dicts.PhnArea1;
  custCompanyObj.PhnArea2 = dicts.PhnArea2 == null ? "": dicts.PhnArea2;
  custCompanyObj.PhnExt1 = dicts.PhnExt1 == null ? "": dicts.PhnExt1;
  custCompanyObj.PhnExt2 = dicts.PhnExt2 == null ? "": dicts.PhnExt2;
  custCompanyObj.RefIndustryTypeId = dicts.RefIndustryTypeId == null ? "": dicts.RefIndustryTypeId;
  custCompanyObj.RegistrationNo = dicts.RegistrationNo  == null ? "": dicts.RegistrationNo;
  custCompanyObj.VipNotes = dicts.formRaw.VipNotes;
  custCompanyObj.RowVersion = dicts.form.RowVersionCoy;
  custCompanyObj.Website = dicts.Website == null ? "": dicts.Website;
  custCompanyObj.CustApuPptObj.CustId = dicts.IdCust;
