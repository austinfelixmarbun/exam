...
export class Dummy3Component implements OnInit {
  ...
  ngOnInit() {
    ...
    if (this.mode == "edit") {
      ...
      this.http.post("http://r3impl-appsvr.ad-ins.com/Foundation/RefBank/GetRefBankByRefBankIdAsync", BankObj).subscribe(
        (response) => {
  ...
  SaveForm() {
    ...
    if (this.mode == "edit") {
      ...
      this.http.post("http://r3impl-appsvr.ad-ins.com/Foundation/RefBank/EditRefBankAsync", this.bankObj).subscribe(
        (response) => {
          console.log(response);
        },
        (error) => {
      ...
      this.http.post("http://r3impl-appsvr.ad-ins.com/Foundation/RefBank/AddRefbankAsync", this.bankObj).subscribe(
        (response) => {
          console.log(response);
        },
        (error) => {
