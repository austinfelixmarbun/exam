...
export const environment = {
  ...
  FoundationR3Url: 'http://r3impl-appsvr.ad-ins.com/DEMO_BSI/FOUNDATION_DEV_DEMO_BSI',
  ...
  FoundationR3Web: 'http://r3impl-websvr.ad-ins.com/DEMO_BSI/FOUNDATION_DEMO_BSI',
